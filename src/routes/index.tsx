...
const pathPoints: Point[] = [
  ...
  { x: 480, y: 250, color: "flow", radius: 6 },
  { x: 560, y: 332, color: "flow", radius: 7 },
  { x: 650, y: 302, color: "flow", radius: 6 },
  { x: 740, y: 405, color: "flow", radius: 7 },
  { x: 830, y: 449, color: "flow", radius: 6 },
  { x: 920, y: 342, color: "flow", radius: 7 },
  { x: 1010, y: 299, color: "flow", radius: 7 },
  { x: 1090, y: 349, color: "flow", radius: 6 },
  { x: 1160, y: 286, color: "flow", radius: 6 },
  { x: 1200, y: 225, color: "flow", radius: 7 },
  { x: 1225, y: 247, color: "flow", radius: 6 },
  { x: 1240, y: 291, color: "flow", radius: 6 },
  { x: 1250, y: 318, color: "flow", radius: 6 },
