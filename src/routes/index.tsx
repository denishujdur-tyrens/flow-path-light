...
const pathPoints: Point[] = [
  ...
  { x: 500, y: 250, color: "flow", radius: 6 },
  { x: 600, y: 332, color: "flow", radius: 7 },
  { x: 700, y: 302, color: "flow", radius: 6 },
  { x: 780, y: 405, color: "flow", radius: 7 },
  { x: 880, y: 449, color: "flow", radius: 6 },
  { x: 980, y: 342, color: "flow", radius: 7 },
  { x: 1060, y: 299, color: "flow", radius: 7 },
  { x: 1130, y: 349, color: "flow", radius: 6 },
  { x: 1190, y: 286, color: "flow", radius: 6 },
  { x: 1225, y: 225, color: "flow", radius: 7 },
  { x: 1245, y: 247, color: "flow", radius: 6 },
  { x: 1265, y: 291, color: "flow", radius: 6 },
  { x: 1280, y: 318, color: "flow", radius: 6 },
  { x: 1300, y: 334, color: "flow", radius: 8 },
];
